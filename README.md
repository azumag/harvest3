...
Web UIが実装されました。Webブラウザからボットの状態を監視したり、操作したりすることができます。

### 概要

Web UIは、以下の機能を提供し、ボットの状態をリアルタイムで監視・操作することができます。

- **ポジション**: 現在のポジション状況（通貨ペア、数量、価格など）を一覧で確認できます。
- **履歴**: 過去の取引履歴を詳細に確認できます。フィルタリングやソートも可能です。
- **分析**: 損益グラフや取引統計など、ボットのパフォーマンスを分析するための情報を提供します。

### 使い方

Web UIを使用するには、以下の手順に従ってください。
...
(スクリーンショットはイメージです。実際のUIとは異なる場合があります。)
