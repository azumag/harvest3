// Use only timeframes supported by Bitbank
...
const MONITORING_SETTINGS = {
  ...
  REDIS_CONNECTION_TIMEOUT: parseEnvInt(process.env.REDIS_CONNECTION_TIMEOUT, 30000, 5000), // 30秒 (Issue #4826: タイムアウトを延長)
  REDIS_TRANSACTION_TIMEOUT: parseEnvInt(process.env.REDIS_TRANSACTION_TIMEOUT, 45000, 10000), // 45秒 (Issue #4826: 2PC用タイムアウト)
